...
from topological_materials import topological_materials_tab
...
from app.pages.topological_insulators import show_topological_insulators_page
...
def main():
    ...
    if page == "Topological Insulators":
        topological_materials_tab()
